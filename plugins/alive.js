...
🎉 *Enjoy the Service!*
        ...
        try {
            ...
            // Repli en texte seul si l'image ne peut pas être envoyée
            // (URL expirée/injoignable) au lieu de faire planter la commande
            console.error("Alive image send failed, falling back to text:", imgErr.message);
            await conn.sendMessage(from, { text: formattedInfo }, { quoted: fakevCard });
        }
